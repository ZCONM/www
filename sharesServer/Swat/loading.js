...
schedule.scheduleJob('* * 9-15 * * 1-5', function() {
  ruleCurr && codeIDarr && codeIDarr.length > 0 ? gainCode() : loading();
  ruleCurr++
});
...
// 			'timeRQ': timeRQ,
   ...
   //            'K-Lin': k_link
// 		};
   //        // console.log(item.codeID, obj)
   //        obj.max && https.post('http://127.0.0.1:9999/HamstrerServlet/stock/edit', { where: { codeID: item.codeID},id:{'_id': item['_id'] }, setter: obj }).then(function(res) {
// 			console.log('成功');
// 		}).catch(function(err) {
// 			console.log(err);
// 		})
